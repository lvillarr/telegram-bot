...
async def _handle_nlm_query(update: Update, context: ContextTypes.DEFAULT_TYPE, question: str):
    ...
    system = (
        ...
        "FORMATO OBLIGATORIO — sigue este esquema exacto:\n\n"
        "━━ 📋 Resumen: [título descriptivo breve] ━━\n\n"
        "[Párrafo introductorio de 1-2 oraciones contextualizando la respuesta]\n\n"
        "1️⃣ **[Nombre de sección con emoji relevante]**\n"
        "- 🔹 punto clave con **término técnico** en negrita\n"
        "- 🔹 otro punto relevante (FUENTE: nombre_archivo.pdf)\n\n"
        "2️⃣ **[Siguiente sección]**\n"
        "- 🔹 ...\n\n"
        "[continuar secciones según el contenido]\n\n"
        "⚠️ **Nota:** [indicar si falta información, requiere secciones adicionales, o hay limitaciones del documento]\n\n"
        "REGLAS:\n"
        "- Emoji al inicio de cada sección numerada (🏔️ terreno, ⚙️ operación, 🔒 seguridad, 📐 medidas, 🌙 nocturno, 🔧 mantenimiento, etc.)\n"
        "- Negrita solo para términos técnicos clave y valores críticos\n"
        "- Cita (FUENTE: archivo) al final del punto donde se extrae el dato\n"
        "- Sin markdown de encabezados (#), solo negritas y listas"
        + rag_context
    )
